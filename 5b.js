...
var charModels = [
	...
	},
	{
		...
		frames: [
			...
			[
				{type:'static',bodypart:3,mat:{a:0.2680206298828125,b:-0.1997222900390625,c:-0.1997222900390625,d:-0.2680206298828125,tx:-5.7,ty:-23.55}},
				...
				{type:'static',bodypart:3,mat:{a:-0.2680206298828125,b:-0.1997222900390625,c:0.1997222900390625,d:-0.2680206298828125,tx:5.75,ty:-25.4}}
			],
			[
				{type:'static',bodypart:3,mat:{a:-0.2680206298828125,b:-0.1997222900390625,c:0.1997222900390625,d:-0.2680206298828125,tx:6.8,ty:-23.55}},
				...
				{type:'static',bodypart:3,mat:{a:0.2680206298828125,b:-0.1997222900390625,c:-0.1997222900390625,d:-0.2680206298828125,tx:-4.65,ty:-25.4}}
			],
			[
	...
	},
	{
		...
		frames: [
			[
				{type:'body',mat:{a:0.3648529052734375,b:0,c:0,d:0.3648529052734375,tx:0.4,ty:-39.1}}
			],
			[
				{type:'body',mat:{a:0.3648529052734375,b:0,c:0,d:0.3648529052734375,tx:0.4,ty:-39.1}}
			],
			...
			if (currCharID > 34) {
				...
				for (var i = 0; i < modelFrame.length; i++) {
					...
					ctx.transform(
						...
						char[_loc1_].y+modelFrame[i].mat.ty+yoff+(modelFrame[i].type != 'anim'?runbob:0)
					);
					if (modelFrame[i].type == 'anim') {
						...
						if (cutScene == 1 && dialogueChar[currentLevel][cutSceneLine] == _loc1_) {
							...
							if (char[_loc1_].diaMouthFrame < diaMouths[expr].frameorder.length) char[_loc1_].diaMouthFrame++;
						} else {
